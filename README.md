<p align="center">
  <img src="./banner.png" alt="AI-Game-Crafter Banner" width="100%">
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white"> (Pygame, Pyxel) &nbsp;
  <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black"> (HTML Canvas, Phaser) &nbsp;
  <img src="https://img.shields.io/badge/C%23-239120?style=flat-square&logo=c-sharp&logoColor=white"> (Unity)
</p>
<p align="center">
  <b>AI & Development Tools</b><br>
  <img src="https://img.shields.io/badge/AI_Tools-Gemini%20%7C%20Claude-8E44AD?style=flat-square"> &nbsp;
  <img src="https://img.shields.io/badge/Dev_Tool-Antigravity-E67E22?style=flat-square">
</p>
<br>
...
| :---------------------- | :-----: | :----------------------------------------------------------------------------- | :-------------------------------------------------- |
| **[Super Mario Clone]** | Stage 1 | <img src="https://img.shields.io/badge/Status-Setup-yellow?style=flat-square"> | Environment setup & logic analysis with Gemini      |
| **[Pokemon Style RPG]** | Stage 1 | <img src="https://img.shields.io/badge/Status-Setup-yellow?style=flat-square"> | Architecture design & asset preparation with Claude |
...
| 프로젝트명              | 레벨  | 상태                                                                         | 상세 내용                                  |
| :---------------------- | :---: | :--------------------------------------------------------------------------- | :----------------------------------------- |
| **[슈퍼 마리오 클론]**  | 1단계 | <img src="https://img.shields.io/badge/상태-Setup-yellow?style=flat-square"> | Gemini를 활용한 환경 설정 및 로직 분석     |
| **[포켓몬 스타일 RPG]** | 1단계 | <img src="https://img.shields.io/badge/상태-Setup-yellow?style=flat-square"> | Claude를 활용한 아키텍처 설계 및 에셋 준비 |
...
| :---------------------------- | :-----: | :--------------------------------------------------------------------------------- | :--------------------------------------------------- |
| **[スーパーマリオ クローン]** | 第1段階 | <img src="https://img.shields.io/badge/ステータス-Setup-yellow?style=flat-square"> | Geminiを活用した環境構築およびロジック分析           |
| **[ポケモンスタイル RPG]**    | 第1段階 | <img src="https://img.shields.io/badge/ステータス-Setup-yellow?style=flat-square"> | Claudeを活用したアーキテクチャ設計およびアセット準備 |
